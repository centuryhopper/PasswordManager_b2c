...
public class EncryptionContext
{
    ...
    */
    ...
    public EncryptionContext(IConfiguration config)
    {
        _config = config;
        string _encKey = config.GetConnectionString("EncryptionKey")!;
        string _initVector = config.GetConnectionString("InitVector")!;
